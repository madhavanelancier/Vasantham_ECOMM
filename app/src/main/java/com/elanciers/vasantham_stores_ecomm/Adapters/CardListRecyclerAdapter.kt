...
class CardListRecyclerAdapter(val activity : Activity, private var items: ArrayList<CardsResponse>/*, private val listener: OnItemClickListener,*/ /*ps:Int, private var onBottomReachedListener : OnBottomReachedListener */) : RecyclerView.Adapter<CardListRecyclerAdapter.DataObjectHolder>(),
    Filterable
{
    private var ListFiltered: ArrayList<CardsResponse>?
    init {
        ListFiltered = items
    }
    private var orig: ArrayList<CardsResponse>? = null
    ...
    override fun onBindViewHolder(holder: DataObjectHolder, position: Int) {
        ...
        holder.cardno.setText(items[position].cardNo)
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun performFiltering(constraint: CharSequence): FilterResults {
                ...
                val results: ArrayList<CardsResponse?> = ArrayList<CardsResponse?>()
                //results = searchList
            ...
            override fun publishResults(constraint: CharSequence, results: FilterResults) {
                ListFiltered = results.values as ArrayList<CardsResponse>?
                notifyDataSetChanged()
            }
        }
    }
